                ...
                <table>
                  <tbody>
                    <tr className="m-row">
                      ...
                      <td className="m-tc" data-locate="about.r11v">Bizplus株式会社</td>
                      <td className="m-tl" data-locate="about.r12t">
                        设立
                      </td>
                      <td className="m-tc" data-locate="about.r12v">2015年9月</td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tl" data-locate="about.r21t">
                        董事长
                      </td>
                      <td className="m-tc" data-locate="about.r21v">江桥　美香</td>
                      <td className="m-tl" data-locate="about.r22t">
                        行业
                      </td>
                      <td className="m-tc" data-locate="about.r22v">系统开发业 &amp; 咨询业</td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tl" data-locate="about.r31t">
                        董事
                      </td>
                      <td className="m-tc" data-locate="about.r31v">铃木　昌宏</td>
                      <td className="m-tl" data-locate="about.r32t">
                        审计
                      </td>
                      <td className="m-tc" data-locate="about.r32t">审计</td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tl" data-locate="about.r41t">
                        顾问律师
                      </td>
                      <td className="m-tc" data-locate="about.r41v">长 宏一</td>
                    ...
                    <tr className="m-row">
                      ...
                      <td className="m-tc" data-locate="about.r51v">特13-319165</td>
                      <td className="m-tl" data-locate="about.r52t">
                        労働者派遣事業許可証
                      </td>
                      <td className="m-tc" data-locate="about.r52v">派13-309906</td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tl" data-locate="about.r61t">
                        決算月
                      </td>
                      <td className="m-tc" data-locate="about.r61v">8月</td>
                      <td className="m-tl" data-locate="about.r62t">
                        资本金
                      </td>
                      <td className="m-tc" data-locate="about.r62v">2200万日元</td>
                    </tr>
                    <tr className="m-row">
                    ...
                    <tr className="m-row m-row-5">
                      <td className="m-tl m-tl-5" rowSpan="5" data-locate="about.r91t">
                        业务内容
                      </td>
                      <td className="m-tc m-tc-5" colSpan="3" data-locate="about.r91v1">
                        软件委托开发业务
                      </td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tc" colSpan="3" data-locate="about.r91v2">
                        软件开发人员派遣业务
                      </td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tc" colSpan="3" data-locate="about.r91v3">
                        电脑系统管理应用业务
                      </td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tc" colSpan="3" data-locate="about.r91v4">
                        海外顾问业务
                      </td>
                    </tr>
                    <tr className="m-row">
                      <td className="m-tc" colSpan="3" data-locate="about.r91v5">
                        人才教育职业咨询业务
                      </td>
                    </tr>
                  </tbody>
