  ...
  constructor(props) {
    ...
    this.state = {
      ...
      educationContent:[{
        ...
        content:[
          { info: '关于日本文化，日本有独特的规则和习惯，传统文化中还存在非常严格的礼节规则。包括和同事、店员和客人、政治家等其他社会中的场景。' },
          { info: '从每天生活中遇到问题开始，设定主题，比较各个国家的礼仪来进行会话。' },
          { info: '了解日本的风俗习惯，能更好的加深对日本的生活工作的理解，使生活工作顺利进行。' }
        ]
      },{
        title: '商务礼仪',
        imgUrl: 'https://picsum.photos/id/935/500/350',
        content:[
          { info: '学习商业礼仪的感觉不仅会让对方感到不舒服，而且也是使你的工作更有利的武器。' },
          { info: '有各种各样的基础知识，如问候和弓，以及如何通过业务所需的名片。' },
          { info: '商业礼仪就像是交流润滑剂，是连接人的第一步。' },
          { info: '在商业方式教育中，我们将以易于理解的方式研究与在实际商业环境中有用的礼仪相关的常识和要点。' }
        ]
      },{
        title: '沟通技巧',
        imgUrl: 'https://picsum.photos/id/933/500/350',
        content:[
          { info: '「不善于与人交流」的人越来越多、沟通技巧已经成为必要的需求。' },
          { info: '1.语言' },
          { info: '对于沟通交流、比起「说什么」，「怎样向对方传达」才是非常重要的。因此，【传达】【聆听】【询问】是不可缺少的。' },
          { info: '2.语言之外的交流技巧' },
          { info: '表情，声音的音调，举止等等。在说话时，给人带来影响的比例是，语言是1，非语言部分是9。辅助语言、构筑信赖关系、理解对方状况、对此有非常重要的作用。在职场、现场中也会和很多人进行交流，因此，语言之外的交流技巧也是需要学习的。表情，声音的音调，举止等等。在说话时，给人带来影响的比例是，语言是1，非语言部分是9。辅助语言、构筑信赖关系、理解对方状况、对此有非常重要的作用。在职场、现场中也会和很多人进行交流，因此，语言之外的交流技巧也是需要学习的。' }
        ]
      },{
        title: '商务礼仪',
                ...
                <div className="education-teach">
                  <div className="education-teach-inner">
                    ...
                    <div className="education-teach-body">
                      ...
                      <div className="teach-body-table">
                        www
                      </div>
                    </div>
                  </div>
